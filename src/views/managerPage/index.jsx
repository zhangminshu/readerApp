...
import { Layout, Table, Input, Icon, Button, message, Modal, Radio, Popover, Checkbox, Menu,Drawer } from 'antd';
    ...
    render() {
        ...
        const userCol =[{
            ...
            render:(text,record)=>{
                const optContent = (
                    <div>
                      <p className="optItem" onClick={this.fileTypeChange}>修改头像</p>
                      <p className="optItem">修改用户名</p>
                      <p className="optItem">修改邮箱</p>
                      <p className="optItem">修改密码</p>
                      <p className="optItem">账户状态</p>
                      <p className="optItem">存储空间</p>
                    </div>
                  );
